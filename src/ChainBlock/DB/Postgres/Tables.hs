...
credentialsTable :: Table (Maybe (Column PGInt4), Column PGText, Column PGBytea, Column PGInt4, Column PGInt4)
                          (Column PGInt4, Column PGText, Column PGBytea, Column PGInt4, Column PGInt4)
credentialsTable = Table "credentials" (p5 ( optional "id"
                                           , required "username"
